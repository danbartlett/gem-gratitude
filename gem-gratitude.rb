...
file.write '<script src="http://code.jquery.com/jquery-1.10.2.js"></script><script src="http://code.jquery.com/ui/1.11.2/jquery-ui.js"></script>'
file.write '<script>$(function() { $( "#accordion" ).accordion(); }); </script>'
file.write '<link rel="stylesheet" href="http://code.jquery.com/ui/1.11.2/themes/smoothness/jquery-ui.css">'
file.write "<strong>Found #{issue_count} open issues across #{gem_list.count} gems you depend on. Happy hacking!</strong>"

# Write all the content to a HTML file
file.write "<div id='accordian'>"
